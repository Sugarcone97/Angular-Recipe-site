...
export class EditRecipeComponent implements OnInit, OnDestroy {
  ...
  private createForm(): void {
    this.recipeForm = this.fb.group({
      foodname: [this.recipe.foodname, [Validators.required]],
      moreinfo: [this.recipe.moreinfo, [Validators.required]],
      serving: [this.recipe.serving, [Validators.required]],
      foodimg: [this.recipe.foodimg, [Validators.required]],
  ...
  submitForm(): void {
    if (this.recipeForm.valid){
      const { foodname, moreinfo, serving, foodimg, ingredients, instructions} = this.recipeForm.value;
